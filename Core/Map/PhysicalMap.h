...
public:
	enum PhysicalMapAreaType { PhysicalMapAreaTypeWall, PhysicalMapAreaTypeStairs, PhysicalMapAreaTypeOpen, PhysicalMapTypeUnreachable };
...
public:
	PhysicalMap(Core *core, QString filePath, long scale);
	virtual ~PhysicalMap();
