 ...
 *  Joystick.h
 *
 *  The Joystick class can be used to control the various Controllers. It
 ...
 *  at a time. In addition, the Joystick class also provides control over its
...
public:
	Joystick(JoystickMode mode, QWidget *parent = 0);
	virtual ~Joystick();
	double getX();
	double getY();
